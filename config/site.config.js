...
module.exports = {
  ...
  footer:
    'Powered by https://github.com/spencerwooo/onedrive-vercel-index" target="_blank" rel="noopener noreferrer">onedrive-vercel-index. Made with ❤ by FrostWind.',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/1299172402/onedrive-vercel-index',
    },
  ],
